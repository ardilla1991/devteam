...
public final class SqlStatementConstantValue {
	...
	public static final String PROJECT_NEW_LIST = "SELECT p.*, c.* FROM project as p JOIN customer as c ON p.customer_id=c.id WHERE p.status=0 ORDER BY p.dateCreated ";
}
